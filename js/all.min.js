...
lightbox.option({showImageNumberLabel:!1,resizeDuration:400}),$(document).ready(function(){var t=window.location.pathname;$(".nav__link").each(function(){$(this).toggleClass("nav__link--active",$(this).attr("href")==t)})});